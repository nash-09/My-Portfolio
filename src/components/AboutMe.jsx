...
const AboutMe = () => {
  return (
    ...
    <div id='aboutMeSection' className='bg-gray-800 text-slate-400 m-5 mt-0 p-5 rounded-lg text-sm lg:text-base'>
      ...
      <p>When I'm not working on projects, you'll often find me experimenting with design ideas, exploring new technologies, or working on personal projects that challenge my problem-solving abilities. My goal is simple — to create digital experiences that are functional, visually appealing, and unforgettable.</p>
    </div>
  )
}

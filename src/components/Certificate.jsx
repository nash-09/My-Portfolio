...
const Certificate = () => {
  return (
    <div>
      <div className='m-5 p-5 text-slate-400 rounded-lg bg-gray-800'>
      <div><h2 className='text-3xl text-center text-slate-200 font-semibold mb-5'>Certificates</h2></div>
      <div className='flex justify-evenly'>
      <div className='rounded-lg w-1/4 p-3 bg-gray-700'>
      ...
      <div className='rounded-lg w-1/3 p-3 bg-gray-700'>

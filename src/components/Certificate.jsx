    ...
    <div className='text-slate-400 bg-gray-800 p-5 m-5 mt-10 rounded-lg'>
      <h2 className='text-2xl lg:text-3xl text-center text-slate-200 font-semibold mb-5'>Certificates</h2>
        ...
        <div className='flex-col lg:flex lg:justify-evenly lg:flex-row'>
          <div className='rounded-lg lg:w-[30%] w-full lg:h-auto p-5 bg-gray-800 shadow-lg shadow-gray-950'>
            ...
            <p className='text-sky-600 font-semibold inline-block mt-3'>Verfication: </p> <a href="Certificates/RSCITCertificate.jpg" className='text-sky-500 hover:text-sky-700'>View Certificate</a>
          </div>

          <div className='rounded-lg lg:w-[30%] w-full mt-5 lg:mt-0 lg:h-auto p-5 bg-gray-800 shadow-lg shadow-gray-950'>
            ...
            <p className='text-sky-600 font-semibold inline-block mt-3'>Verfication: </p> <a href="Certificates/BasicComputer.jpg" className='text-sky-500 hover:text-sky-700'>View Certificate</a>
          </div>
          ...
          <div className='rounded-lg lg:w-[30%] w-full mt-5 lg:mt-0 lg:h-auto p-5 bg-gray-800 shadow-lg shadow-gray-950'>  
            ...
            <p className='text-sky-600 font-semibold inline-block mt-3'>Verfication: </p> <a href="Certificates/SalesforceCertificate.jpg" className='text-sky-500 hover:text-sky-700'>View Certificate</a>
          </div>
        </div>
    </div>
  )

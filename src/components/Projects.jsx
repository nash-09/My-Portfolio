...
const Projects = () => {
  return (
    <div id='projects' className='text-slate-400 rounded-lg bg-gray-800 m-5 p-5'>
      ...
      <div className='rounded-lg p-5 bg-gray-700'>
      <h3 className='text-2xl font-semibold text-slate-300 mb-3'><span className='text-sky-400'>Project 1 -</span> Personal Portfolio Website</h3>
        ...
        <p className='text-sky-600 font-semibold inline-block mb-5'>GitHub Repository:</p> <a href="https://github.com/nash-09/My-Portfolio" className='text-sky-500 hover:text-sky-700'>View Code</a>
        </div>
        

      {/* Project 2 */}

      <div className='rounded-lg p-5 bg-gray-700 mt-5'>

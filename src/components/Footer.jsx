...
const Footer = () => {
  return (
    <div className='m-5 p-5 rounded-lg text-center bg-gray-800 text-slate-400'>
        <h2 className='text-3xl text-slate-200 font-semibold mb-5'>Footer</h2>
            ...
            <p className='mb-3'>Turning ideas into interactive experiences</p>

            <p className='text-sky-600 font-bold mb-3'>Links Section: </p>
